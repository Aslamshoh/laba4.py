...
# Дополнительный график для итоговой матрицы
print_mat1(result, "Результат - первый ряд")
print_mat2(result, "Результат - суммы столбцов")
print_mat3(result, "Результат - круговая диаграмма")
